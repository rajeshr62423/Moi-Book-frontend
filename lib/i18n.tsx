...
const translations = {
  en: {
    ...
    navReports: "Reports", reportsPageTitle: "Reports", reportsSubtitle: "Generate detailed reports across your events and guests.",
    filtersCardTitle: "Filters", dateFromLabel: "From Date", dateToLabel: "To Date", reportTypeLabel: "Report Type",
    reportTypeEventSummary: "Event Summary", reportTypeGuestReport: "Guest Report", reportTypeAttendanceReport: "Attendance Report", reportTypeEventActivity: "Event Activity",
    generateReport: "Generate Report", retry: "Retry",
    reportsReadyTitle: "Ready to generate", reportsPreGenerateHint: "Choose your filters and generate a report to see results here.",
    reportsEmptyTitle: "No results", reportsEmptyHint: "No events match these filters. Try widening your date range.",
    reportsErrorHint: "Couldn't generate the report",
    statTotalEvents: "Total Events", statConfirmedGuests: "Confirmed", statPendingGuests: "Pending", statAttendance: "Attendance",
    thConfirmed: "Confirmed", thPending: "Pending", thNotAttending: "Not Attending", thAttendance: "Attendance Rate",
    exportReportsTitle: "Export Report", exportExcel: "Export Excel", exportPdf: "Export PDF",
    toastExportExcelSuccess: "Excel report downloaded.", toastExportPdfSuccess: "PDF report downloaded.",
    reportsWord: "reports",
    ...
    sendInvite: "Send Invite", teamMemberEmailField: "Email Address", teamMembersListTitle: "Team Members",
    notTeamOwnerHint: "You're a member of someone else's team, so only they can invite or remove people.",
    noTeamMembersYet: "No team members yet. Invite someone to get started.",
    teamStatusPending: "Invite pending", teamStatusAccepted: "Active member",
    removeMember: "Remove", removeMemberConfirmTitle: "Remove this team member?",
    removeMemberConfirmBody: "They'll lose access to your events, guests, vendors, ledger and moi.",
    privacy: "Privacy", managePrivacy: "Manage privacy",
    downloadApp: "Download App", getMobileApp: "Get the Android app",
  ...
  ta: {
    ...
    navReports: "அறிக்கைகள்", reportsPageTitle: "அறிக்கைகள்", reportsSubtitle: "உங்கள் நிகழ்வுகள் மற்றும் விருந்தினர்கள் குறித்த விரிவான அறிக்கைகளை உருவாக்கவும்.",
    filtersCardTitle: "வடிகட்டிகள்", dateFromLabel: "தொடக்க தேதி", dateToLabel: "முடிவு தேதி", reportTypeLabel: "அறிக்கை வகை",
    reportTypeEventSummary: "நிகழ்வு சுருக்கம்", reportTypeGuestReport: "விருந்தினர் அறிக்கை", reportTypeAttendanceReport: "வருகை அறிக்கை", reportTypeEventActivity: "நிகழ்வு செயல்பாடு",
    generateReport: "அறிக்கையை உருவாக்கு", retry: "மீண்டும் முயற்சி",
    reportsReadyTitle: "உருவாக்க தயார்", reportsPreGenerateHint: "உங்கள் வடிகட்டிகளைத் தேர்ந்தெடுத்து, முடிவுகளைக் காண அறிக்கையை உருவாக்கவும்.",
    reportsEmptyTitle: "முடிவுகள் இல்லை", reportsEmptyHint: "இந்த வடிகட்டிகளுக்குப் பொருந்தும் நிகழ்வுகள் இல்லை. தேதி வரம்பை விரிவுபடுத்த முயற்சிக்கவும்.",
    reportsErrorHint: "அறிக்கையை உருவாக்க முடியவில்லை",
    statTotalEvents: "மொத்த நிகழ்வுகள்", statConfirmedGuests: "உறுதி செய்யப்பட்டது", statPendingGuests: "நிலுவையில்", statAttendance: "வருகை",
    thConfirmed: "உறுதி செய்யப்பட்டது", thPending: "நிலுவையில்", thNotAttending: "வராதவர்கள்", thAttendance: "வருகை விகிதம்",
    exportReportsTitle: "அறிக்கையை ஏற்றுமதி செய்", exportExcel: "Excel ஏற்றுமதி", exportPdf: "PDF ஏற்றுமதி",
    toastExportExcelSuccess: "Excel அறிக்கை பதிவிறக்கம் செய்யப்பட்டது.", toastExportPdfSuccess: "PDF அறிக்கை பதிவிறக்கம் செய்யப்பட்டது.",
    reportsWord: "அறிக்கைகள்",
    ...
    sendInvite: "அழைப்பு அனுப்பு", teamMemberEmailField: "மின்னஞ்சல் முகவரி", teamMembersListTitle: "குழு உறுப்பினர்கள்",
    notTeamOwnerHint: "நீங்கள் வேறொருவரின் குழுவின் உறுப்பினர் — அவர்கள் மட்டுமே அழைக்கவோ நீக்கவோ முடியும்.",
    noTeamMembersYet: "இதுவரை குழு உறுப்பினர்கள் இல்லை. தொடங்க ஒருவரை அழைக்கவும்.",
    teamStatusPending: "அழைப்பு நிலுவையில்", teamStatusAccepted: "செயலில் உள்ள உறுப்பினர்",
    removeMember: "நீக்கு", removeMemberConfirmTitle: "இந்த குழு உறுப்பினரை நீக்கவா?",
    removeMemberConfirmBody: "உங்கள் நிகழ்வுகள், விருந்தினர்கள், விற்பனையாளர்கள், கணக்கீடு மற்றும் மொய் ஆகியவற்றிற்கான அணுகலை அவர்கள் இழப்பார்கள்.",
    privacy: "தனியுரிமை", managePrivacy: "தனியுரிமையை நிர்வகி",
    downloadApp: "ஆப்ஸ் பதிவிறக்கு", getMobileApp: "ஆண்ட்ராய்டு ஆப்ஸைப் பெறுங்கள்",
