...
import { hydrateAuth, login, logout, register, sessionExpired } from "@/redux/auth/thunk";
import type { LoginRequest, RegisterRequest } from "@/redux/auth/type";
...
export function useAuth() {
  ...
  return { user, isReady, loading, error, login: doLogin, register: doRegister, logout: doLogout };
}
